...
| **P1.5** | `测试用例/**/期待价格校正清单.csv` + 814/v8 严格对账 | **账单实践验证**：fixture 标注 `billingEvidence=confirmed` 须有前后账单行；无则 `valid:false`（见 [`docs/sc11-billing-evidence-audit.md`](sc11-billing-evidence-audit.md)） |
