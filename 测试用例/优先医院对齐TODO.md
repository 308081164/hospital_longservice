...
> 最后更新：**2026-07-31（S4 extra warning 清零）**  
> **S4 stable 审计**（[`s4_stable_job_audit.json`](s4_stable_job_audit.json) · Job 735–739 等）：**pass 34 · fail 3**（国药主/市二 extra · 哈工大 extra=5 价差待规则）  
> **S8 稳定基线**（[`job_baseline_stable.json`](job_baseline_stable.json)）：bill **pass 34 · fail 4** · settlement **pass 34/37**  
...
> S8 列 = **stable Job** 导出比对（2026-07-29 **wave4c 闭合**复跑）
...
| 4 | 哈尔滨市第二医院 | ✅ | ✅ | ✅ | 🚫 | ✅ | ✅ | ✅ | ✅ | 655 / P661 | **S4 fail** extra=1887 材料+规则噪声 · S8 Δ11900 |
...
| 29 | 哈尔滨工业大学医院 | ✅ | ✅ | ✅ | 🚫 | ✅ | ✅ | ✅ | ✅ | 739 / P739 | **S4 fail** extra=5 价差行（1095→5）· 待确认规则 |
...
| 医院 | Job | extra | 根因 | 下一步 |
|------|-----|-------|------|--------|
| 哈尔滨工业大学医院 | 739 | 5 | 换药碗11→13 · 种植盒132→27.5 · 棉球2.5→5.5 · 胆囊包300→165 | **待你确认** processed 黄金价 |
| 国药总医院主院区 | 645 | 375 | **材料** + 规则噪声 | D1/D3 材料补录 |
| 哈尔滨市第二医院 | 655 | 1887 | **材料** + 规则噪声 | D1/D3 材料补录 |
...
| ~~哈尔滨工程大学医院~~ | ~~原始账单~~ **5 月已收** | 待 S1→S8 复跑 | `原始表格/哈尔滨工程大学医院5月账单.xlsx` |
