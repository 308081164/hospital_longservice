...
class PackNameSpecParserTest {
    ...
    private static Stream<Arguments> totalPieceCountCases() {
        return Stream.of(
                ...
                // 外套有连字符时括号内规格区间仍忽略
                Arguments.of("扩棒（3-5.5号）-6/z1526", 6),
                // 计数与计价隔离：盒/筐/盘 token 一律参与斜杠前件数累加
