...
class ZyyD1P0PricingRegressionTest {
    ...
    @Test
    void shouldFlagPreviouslyMissedJuneCorrections() {
        assertWarning(row("耳鼻喉病房", "冲洗头-79/z2030", "额外包(低温等离子)", "低温纸塑袋200*300",
                79, 1, 202.4, 202.4), 220);
        assertWarning(row("耳鼻喉病房", "冲洗头-82/Z2030", "额外包(低温等离子)", "低温纸塑袋200*300",
                82, 1, 202.4, 202.4), 237.6);
        assertWarning(row("耳鼻喉病房", "橄榄头-102/z2030", "额外包(低温等离子)", "低温纸塑袋200*300",
                102, 1, 275.2, 275.2), 257.6);
        assertWarning(row("眼科门诊手术室（一）", "球内注药-3件/Z1020", "额外包(纸塑袋)", "高温纸塑袋150*260",
                3, 15, 15.2, 228), 13.2);
        assertWarning(row("眼科门诊手术室（二）", "球内注药-3件/Z1526", "额外包(纸塑袋)", "高温纸塑袋150*260",
                3, 4, 17.6, 70.4), 13.2);
        assertWarning(row("手术室(一区)", "膀胱取石钳-1/z1560", "额外包(ETO)", "高温纸塑袋150*600",
                1, 1, 8.8, 8.8), 20);
        assertWarning(row("手术室(一区)", "保温杯-1Z2044", "额外包(ETO)", "高温纸塑袋200*440",
                2, 2, 10.4, 20.8), 17.6);
    }

    @Test
    void shouldCorrectWrongPriceTargetsFromJuneReport() {
        assertWarning(row("手术室(一区)", "王树人特器-26（筐1）/w12050", "额外包(ETO)", "无纺布-120×120-50g",
                27, 1, 292.8, 292.8), 328);
