...
public class GrandTotalExportStrategy implements ExportStrategy {
    ...
    public String strategyKey() {
        return ExportTemplateResolverKeys.GRAND_TOTAL;
    }
    ...
    public ExportResult export(ExportContext context) throws Exception {
        ...
        byte[] content = sheetOrchestrator.buildGrandTotalWorkbook(context.getHospitalName(), allocation);
        String fileName = safeName(context.getHospitalName()) + "_grand_total_v2_"
