...
V8_HOSPITALS: list[V8Hospital] = [
    ...
    V8Hospital("松电慢病", "松电慢病", False, "缺 3 月原始表"),
    ...
    V8Hospital("海员松北", "黑龙江省海员总医院（松北）", False, "缺 3–4 月原始表"),
    V8Hospital("省妇幼人口", "黑龙江省妇幼保健院（人口）", False, "缺 7 月处理后"),
    V8Hospital("祖研南岗", "祖研-黑龙江省中医医院（南岗院区）", True),
    V8Hospital("社会康复", "黑龙江省社会康复医院", True),
    V8Hospital("道里妇幼", "道里区妇幼保健院", False, "缺 7 月 raw+proc 成对"),
    V8Hospital("春语医美", "春语医美", False, "缺 7 月 raw+proc 成对"),
    V8Hospital("总工会", "总工会", False, "缺 7 月 raw+proc 成对"),
    V8Hospital("基准生物", "基准生物", False, "缺 7 月 raw+proc 成对"),
    V8Hospital("索菲医美", "索菲医美", False, "缺 7 月 raw+proc 成对"),
    V8Hospital("省监狱管理局", None, False, "无测试用例目录"),
]
